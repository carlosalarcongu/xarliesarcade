...
const SHOP_CATALOG = {
    ...
    'boost:hp_up': { id: 'cobblemon:hp_up', count: 3, cost: 1 },
    'boost:protein': { id: 'cobblemon:protein', count: 3, cost: 1 },
    'boost:iron': { id: 'cobblemon:iron', count: 3, cost: 1 },
    'boost:calcium': { id: 'cobblemon:calcium', count: 3, cost: 1 },
    'boost:zinc': { id: 'cobblemon:zinc', count: 3, cost: 1 },
    'boost:carbos': { id: 'cobblemon:carbos', count: 3, cost: 1 },
    'boost:pp_max': { id: 'cobblemon:pp_max', count: 3, cost: 1 },
