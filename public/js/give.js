    ...
    sections: {
        ...
        equipo_pkmn: {
            ...
            items: [
                ...
                { id: "boost:hp_up", name: "Car. PS", icon: "❤️" },     
                { id: "boost:protein", name: "Car. Proteína", icon: "🍗" },
                { id: "boost:iron", name: "Car. Hierro", icon: "🔩" },
                { id: "boost:calcium", name: "Car. Calcio", icon: "🧂" },
                { id: "boost:zinc", name: "Car. Zinc", icon: "🧪" },
                { id: "boost:carbos", name: "Car. Carbos", icon: "🍞" },
                { id: "boost:pp_max", name: "Car. PP Max", icon: "🔋" },
